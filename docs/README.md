...
| Synchronize the native Woo unit attribute | [`api/FOLIO_FULL_SYNC_UNIT_ATTRIBUTE.md`](api/FOLIO_FULL_SYNC_UNIT_ATTRIBUTE.md); full sync adds pa_edin_izmer and keeps legacy meta, merging existing attributes and narrowly filling missing units on hash-unchanged cards |
